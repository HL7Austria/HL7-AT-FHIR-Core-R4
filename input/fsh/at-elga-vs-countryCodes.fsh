...
* description = "Value Set for ISO 3166-1 alpha 3 used in ELGA. Also accessible on https://termpub.gesundheit.gv.at:443/TermBrowser/gui/main/main.zul?loadType=ValueSet&loadName=ELGA_Laendercodes."
