...
* expansion.contains[7].contains[0].designation[0].use.system = "http://snomed.info/sct"
* expansion.contains[7].contains[0].designation[0].use.code = #900000000000003001
* expansion.contains[7].contains[0].designation[0].value = "mgl"
